...
// GOOD LUCK 😀
const calcAverageHumanAgeArrowChaning = (ages) =>
  ages
...
// ===============================================
console.log(dogs.some(dog => dog.curFood > (dog.recFood * 0.9) && dog.curFood < (dog.recFood * 1.1) ? true : false));
// ===============================================
console.log(dogs.every(dog => dog.curFood > (dog.recFood * 0.9) && dog.curFood < (dog.recFood * 1.1) ? true : false));
// ===============================================
console.log(dogs.filter(dog => dog.curFood > (dog.recFood * 0.9) && dog.curFood < (dog.recFood * 1.1) ? true : false));

// ===============================================

const dogsSorted = Object.groupBy(dogs,dog =>
dog.curFood > (dog.recFood * 0.9) && dog.curFood < (dog.recFood * 1.1) ? 'exact' : dog.curFood > dog.recFood ? 'too-much' : 'too-little'
)
